...
public class PopuJar extends PopupWindows implements OnDismissListener {
		...
		container.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mItemClickListener != null) {
					mItemClickListener.onItemClick(PopuJar.this, mposition, actionId);
				}

				if (!getPopuItem(mposition).isSticky()) {
					mDidAction = true;
	...
	public void show (View view) {
		...
		mWindow.showAtLocation(view, Gravity.NO_GRAVITY, xPos, yPos);
	}
